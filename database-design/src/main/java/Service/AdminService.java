...
//        sc.close();
    ...
    public static void addMentor() {
        ...
        boolean check = mentorDao.addMentor(Mno, Mname, Lno);
        if (check) {
            System.out.println("添加成功");
        } else {
...
//        sc.close();
    ...
    public static void addStudent() {
        ...
        boolean check = studentDao.addStudent(Sno, Sname, Smajor, Mno, Stype);
        if (check) {
            System.out.println("添加成功");
        } else {
            System.out.println("添加失败");
...
//        sc.close();
    ...
    public static void aotuGenerateStudentLoginAccountByMno() {
        ...
        for (Student student : students) {
            if (student.getMno() != null && student.getMno().equals(Mno) && !loginDetailDAO.isExistStudent(student.getSno())) {
                loginCheckDAO.addLoginCheck(student.getSno(), student.getSno());
                loginDetailDAO.addLoginDetail(student.getSno(), "student", student.getSno());
            }
        }
